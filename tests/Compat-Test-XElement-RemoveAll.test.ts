...
// Ports the C# example from XElement.RemoveAll method reference page.
// Source: https://learn.microsoft.com/en-us/dotnet/api/system.xml.linq.xelement.removeall?view=netframework-4.8.1
...
describe('XElement.RemoveAll', () => {
  it('removes both attributes and child nodes, leaving an empty element', () => {
